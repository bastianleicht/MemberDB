...
if (isset($_POST['deleteMember'])) {
    ...
    $session_token = $user->getDataById($userid, 'session_token');

    if($user->isAdmin($session_token)) {

        $SQL = $db->prepare("DELETE FROM `member` WHERE `id` = :id");
        $SQL->execute(array(":id" => $id));

        echo sendSuccess('Member erfolgreich gelöscht!');
        header('refresh:2;url=' . $helper->url() . 'members');

    } else {
        echo sendInfo('Diese Funktion ist für User Deaktiviert!');
    }
}
                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col-lg-4">
                            ...
                            <button type="button" class="btn btn-primary btn-block mb-2" data-toggle="modal" data-target="#exampleModal">Edit</button>
                            <form method="post">
                                <button type="submit" formmethod="post" name="deleteMember" class="btn btn-danger btn-block mb-2">Delete</button>
                            </form>
                        </div>
                        ...
                        <div class="col-lg-8">
                            ...
                            <div class="tab-content">
                                <div class="tab-pane fade show active" id="info" role="tabpanel" aria-labelledby="info-tab">
                                    ...
                                    <div class="form-group row">
                                        <label class="col-sm-3 col-form-label">ClanWars:</label>
                                        <div class="col-sm-9">
