            <footer class="footer">
                <div class="w-100 clearfix">
                    <span class="text-muted d-block text-center text-sm-left d-sm-inline-block">Copyright © 2020 <a href="https://encrosystems.de" target="_blank">encrosystems</a>. All rights reserved. Made with <i class="mdi mdi-heart-outline text-danger"></i> by <a href="https://routerabfrage.net" target="_blank">routerabfrage</a></span>
