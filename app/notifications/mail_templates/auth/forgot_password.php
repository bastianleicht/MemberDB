...
$mailContent = '<div style="padding: 60px 70px; border-top: 1px solid rgba(0,0,0,0.05);">
            ...
            <div style="color: #636363; font-size: 14px;">
               <p>
                  Du hast dein Passwort vergessen? Kein Problem klicke einfach auf den folgenden Link um dein Passwort zur&uuml;cksetzen.
               </p>
               <br>
            ...
            <div style="color: #A5A5A5; font-size: 12px;">
               <p>
                  Erstelle eine <a href="'.$helper->url().'support" style="text-decoration: underline; color: #4B72FA;">Supportanfrage</a> oder schreiben uns eine Mail <a href="mailto:admin@avorox.de" style="text-decoration: underline; color: #4B72FA;">admin@avorox.de</a>
               </p>
            </div>
         </div>';
